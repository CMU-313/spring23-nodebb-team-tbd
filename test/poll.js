...
const config_1 = __importDefault(require("nodebb-plugin-poll-modified/lib/config"));
...
describe('Creating poll and (de)serializing...', () => {
    it('deserialize should undo serialize', (done) => {
        ...
        const config = config_1.default.defaults;
        // eslint-disable-next-line max-len
        // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-member-access
        const samePollString = serializer_1.default.deserialize(
        // eslint-disable-next-line max-len
        // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-assignment
        serializer_1.default.serialize(pollString, config), config);
    ...
    it('serialize should undo deserialize', (done) => {
        ...
        // eslint-disable-next-line max-len
        // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-assignment
        const samePollConfig = serializer_1.default.serialize(serializer_1.default.deserialize(pollConfig, config), config);
    ...
    describe('Serializer should accept color, horizontal, and other existing options...', () => {
        it('should have both horizontal field and color field filled', (done) => {
            ...
            // eslint-disable-next-line max-len
            // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-assignment
            const pollConfig = serializer_1.default.serialize(pollString, config);
    ...
    describe('Deserializer should accept color, horizontal, and other existing options...', () => {
        it('should have both horizontal field and color field filled', (done) => {
            ...
            // eslint-disable-next-line max-len
            // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-assignment
            const pollString = serializer_1.default.deserialize(pollConfig, config);
        ...
        it('should fail if type is not correct', (done) => {
            try {
                ...
                serializer_1.default.deserialize(pollConfig, config);
